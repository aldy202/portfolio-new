<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-cyan-200">Hello I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Aldy Ahmad Fauzi</h1>
      <div class="py-2">
        <h1
          class="typewrite text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-cyan-300 md:text-2xl fadein-up"
          ref="typewriter">
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-cyan-200 pict" src="profile/profil.jpeg">
    </div>
  </main>
</template>
...
.pict {
  box-shadow: 0px 0px 73px -9px rgba(112, 248, 255, 0.44);
-webkit-box-shadow: 0px 0px 73px -9px rgba(112, 248, 255, 0.44);
-moz-box-shadow: 0px 0px 73px -9px rgba(112, 248, 255, 0.44);
}
